...
ESP32 DevKit + PIR motion sensor + LED + vibration motor + I²C OLED (+ optional relay).
...
| Vibration motor module | VCC / + | **3.3V** | 5V also fine on most modules |
| Vibration motor module | IN / S | **GPIO 5** | buzzes on motion |
| Vibration motor module | GND / – | **GND** | |
